...
- **Installable (PWA)** — add the dashboard to a laptop, phone, or tablet; in app mode remote sessions take the full screen instead of a browser window. Needs https (or localhost) to install.
